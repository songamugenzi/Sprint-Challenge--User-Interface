...
Semantic HTML gives tags meaning which allows you to quickly know the meaning of a tag as soon as you read it.

2. What are the 4 areas of the box model?

The box model contains: content, padding, a border, and a margin.

3. While using flexbox, what axis does the following property work on: ```align-items: center```?

In flexbox, that property would work on the cross axis (vertical axis).

4. Explain why git is valuable to a team of developers.

Git is a distributed version control system which enables asynchronous workflows by default. Branching and merging allows engineering teams to split work into smaller, more manageable changes which then allows asynchronous workflows to be successful.

5. Define mobile-first design in your own words.

Mobile-first design means that we start the product design from mobile screensizes which have more restrictions, then we expand to bigger screen sizes, adding more advanced and unique features.
